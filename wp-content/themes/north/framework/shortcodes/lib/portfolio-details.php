...
function vntd_portfolio_details($atts, $content) {
	...
	if($client) {
		$output .= '<li class="p-feature"><h4 class="bold font-secondary">'.__('Team','vntd_north').'</h4><p class="normal">'.$client.'</p></li>';
	}

    if($client) {
        $output .= '<li class="p-feature"><h4 class="bold font-secondary">'.__('Duration','vntd_north').'</h4><p class="normal">'.$duration.'</p></li>';
    }

	if($client) {
		$output .= '<li class="p-feature"><h4 class="bold font-secondary">'.__('Tags','vntd_north').'</h4><ul class="list list-horizontal no-padding no-margin">';

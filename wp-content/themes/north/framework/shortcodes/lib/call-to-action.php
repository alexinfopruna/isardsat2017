...
function vntd_cta($atts, $content=null) {
	...
	if($style != 'centered') {
        $src = wp_upload_dir();
        $src_heading = $src['baseurl'].'/2015/12/logo-isardSAT-blanc-1024x194.png';
		$return .= '<div class="content-left white'.$subtitle_extra_class.'"><img id="heading_img" src="'.$src_heading.'">'.$subtitle.'</div>';
        ...
        $src = wp_upload_dir();
        $src_mouseout = $src['baseurl'].'/2015/12/0311.png';
        $src_mouseover = $src['baseurl'].'/2015/12/isard-vermell-M.png';
        $return .= '<div class="content-right white"><a href="javascript:void(0);" onclick="jQuery(\'.ls-v5\').layerSlider(3);" id="isard_button" class="page-content-button scroll font-primary uppercase white"><img id="isard_img" src="'.$src_mouseout.'" onmouseover="this.src=\''.$src_mouseover.'\'" onmouseout="this.src=\''.$src_mouseout.'\'"></a>'.$button2.'</div>';

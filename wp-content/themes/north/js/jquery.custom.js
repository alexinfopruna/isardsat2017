...
/*    */   
    ...
    var team_carousel = jQuery(".team-boxesxxx").owlCarousel({
    	items : 4,
    	// Responsive Settings
    	itemsDesktop : [1169,4],
    ...
    jQuery( ".team-boxes .owl-wrapper-outer" ).mouseenter(function() {
        window.inside_team = true;
    });
...
=============================================== */
    ...
    var logos_carousel = jQuery(".logos").owlCarousel({
    	items : 10,
    	// Responsive Settings
    	itemsDesktop : [1169,5],
    ...
    window.inside_logos = false;

    jQuery( ".client-logos .owl-wrapper-outer" ).mouseenter(function() {
        window.inside_logos = true;
    });

    jQuery( ".client-logos .owl-wrapper-outer" ).mouseleave(function() {
        window.inside_logos = false;
    });

    setInterval(function(){
        if(!inside_logos){
            logos_carousel.trigger("owl.next");
        }
    },2000);
